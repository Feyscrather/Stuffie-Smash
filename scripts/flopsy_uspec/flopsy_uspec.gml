	...
	*/
	...
	if (run)
		...
		switch (_phase)
			...
			case 1:
				{
				if (stick_tilted(Lstick)) custom_attack_struct.fox_uspec_dir += sign(angle_difference(stick_get_direction(Lstick), custom_attack_struct.fox_uspec_dir))*2;
				//Late hitbox
				if (attack_frame == 20)
					{
